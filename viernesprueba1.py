...
def iniciar_grabacion():
    ...
    RATE = 44100
    RECORD_SECONDS = 10
    WAVE_OUTPUT_FILENAME = "C:\\Users\\Usuario\\Desktop\\RdV\\grabacion.wav"
...
def mostrar_menu():
    ...
    print("1. Iniciar grabación de la sesión")
    print("2. Ver la lista de apartados de la agenda")
    print("3. Ver la lista de puntos de la agenda")
    print("4. Ver la lista de participantes")
    print("5. Modificar la lista de apartados de la agenda")
    print("6. Modificar la lista de puntos de la agenda")
    print("7. Modificar la lista de participantes")

    opcion = input("Por favor, ingrese una opción: ")
    if opcion == "1":
        print("Iniciando grabación de la sesión...")
        iniciar_grabacion()
    elif opcion == "2":
        print("Mostrando lista de apartados de la agenda...")
    elif opcion == "3":
        print("Mostrando lista de puntos de la agenda...")
    elif opcion == "4":
        print("Mostrando lista de participantes...")
    elif opcion == "5":
        print("Modificando lista de apartados de la agenda...")
    elif opcion == "6":
        print("Modificando lista de puntos de la agenda...")
    elif opcion == "7":
        print("Modificando lista de participantes...")
    else:
