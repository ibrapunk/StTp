...
def reporte1(lista):
    for x in lista:
        ...
        print("\n")
"""
Aca vamos a imprimir el apartado, sub apartado, participante, hora de inicio y lo que se dijo en la sesion.
"""
...
#Esta función será un menú principal de reportes donde seleccionamos cual reporte queremos
while True:
